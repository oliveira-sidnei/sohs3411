...
@ViewScoped
@ManagedBean
public class EditaLojistaBean implements Serializable{
	...
	public String salva() {
		controladorLojista.editaLojista(lojistaSelecionado);
		controladorMensagens.addMsgInfo("lojista.editado");
